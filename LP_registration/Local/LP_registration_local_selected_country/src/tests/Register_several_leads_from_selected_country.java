...
public class Register_several_leads_from_selected_country 
{
	...
	@Test // Register several(count of leads=i) leads from random countries using Russian LP on Local
	public void Test1()
	{	
		...
		RegistrationPage registrationPage = new RegistrationPage(driver) ;
			...
			for (int i = 1; i <= 2; i++) //i - number of leads, you can set it as you want
				...
				registrationPage.selectValueFromDD("Австрия"); // select country from dropdown, you can change it
