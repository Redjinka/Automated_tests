...
public class Register_several_leads_from_selected_country 
{

	@Test // Register several(count of leads=i) leads from selected country using English LP on Production
	public void Test1()
	{	
		...
		RegistrationPage registrationPage = new RegistrationPage(driver) ;
			...
			int count = 0;
			for (int i = 1; i <= 2; i++) //i - number of leads, you can set it as you want
				{
				count=i;
				registrationPage.openRegistrationPage(); 
				registrationPage.selectValueFromDD("Russia");// select country from dropdown, you can change it
